...
def main():
    ...
    # argv_json_file = 'configs/pct/multi_task_superglue.json'
    ...
    data_args.train_file = data_args.train_file # '../../data/sentiment/SST-2/sst2_poisoned/train.tsv'
    data_args.validation_file = data_args.validation_file # '../../data/sentiment/SST-2/dev.tsv'
    data_args.test_file = data_args.test_file # '../../data/sentiment/SST-2/sst2_poisoned/dev.tsv'
    ...
    if training_args.do_train:
        ...
        train_dataset = train_dataset.select(torch.arange(0, 84000))
